...
import { Users, Gamepad2, Activity, UserPlus, Lightbulb } from "lucide-react";
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-700 mb-4">
              Ayúdanos a mejorar Didactifonis sugiriendo juegos educativos que
              necesitas para tus pacientes. Tu feedback es valioso.
            </p>
            <div className="flex gap-3">
              <Button
                variant="primary"
              ...
              >
                Ver Sugerencias de la Comunidad
              </Button>
            </div>
          </div>
        </div>
